...
![SeichiGo 首页：动漫圣地巡礼、AI 行程规划与点位地图入口](docs/images/readme/overview.png)
...
![AI 行程规划入口，展示英文界面的旅行需求输入区域](docs/images/readme/ai-planner.png)
...
![SeichiGo 公开首页中的行程示例，展示行程概览与逐日时间线](docs/images/readme/ai-itinerary.png)

*首页展示的历史公开行程示例，截图日期为 2026 年 9 月 22 日。当前可规划的天数与功能以以下套餐说明为准。*
...
![英文界面的动漫圣地巡礼地图，展示作品列表和地理标记](docs/images/readme/map-explorer.png)
...
![圣地点位详情面板，展示动画场景图片与点位操作](docs/images/readme/map-point.png)
...
![点位分享面板与可下载的动漫圣地巡礼分享卡](docs/images/readme/map-share.png)

*README 中所有配图均为 2026 年 9 月 22 日实际操作浏览器拍摄的 SeichiGo 英文界面。行程图为上文注明的首页公开示例。界面和功能开放情况可能随产品更新而变化。*
