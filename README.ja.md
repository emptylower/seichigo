...
![アニメ聖地巡礼、AI 旅行プランニング、スポットマップを紹介する SeichiGo のホームページ](docs/images/readme/overview.png)
...
![旅行の希望を入力できる AI プランナーの開始画面（英語表示）](docs/images/readme/ai-planner.png)
...
![SeichiGo の公開ホームページに掲載された、旅行の概要と日別タイムラインの表示例](docs/images/readme/ai-itinerary.png)

*ホームページで公開している過去の旅程例です。撮影日は 2026 年 9 月 22 日。現在利用できる日数と機能は、以下のプラン説明をご確認ください。*
...
![作品一覧と地理マーカーを表示したアニメ聖地巡礼マップ（英語表示）](docs/images/readme/map-explorer.png)
...
![アニメの場面画像と各種操作を表示するスポット詳細パネル](docs/images/readme/map-point.png)
...
![ダウンロードできる聖地巡礼カードを表示した共有パネル](docs/images/readme/map-share.png)

*README の画像はすべて、2026 年 9 月 22 日に SeichiGo の英語画面を実際にブラウザーで操作して撮影したものです。旅程の画像は、上記の公開ホームページのデモです。画面や機能の提供状況は更新される場合があります。*
