...
- 生产 curl 复验：2026-09-14 部署后完成，见文末。
...
- 发布日期 D：2026-09-14（UTC 06:47）
- 部署版本：Worker Version ID `cc6226f9-db6d-43e4-a80f-8a6dc69778a3`，标签 `deploy/2026-09-14T06-47-13Z`，main 合并提交 ecbd99b4
- 正式基线（D 前最近 14 天完整窗口 2026-08-29 至 09-11；page=`https://seichigo.com/`、query 精确「圣地巡礼」、全部国家、Web）：移动 19 点击 / 287 曝光，CTR 6.6%，平均排名 3.8；桌面 12 / 182，CTR 6.6%，平均排名 3.9；平板 1 / 8
- 品牌词基线（query 精确 `seichigo`，同窗口，全站）：曝光 4、点击 2（移动 2/2，桌面 0/2），平均排名 1
...
### 生产 curl（2026-09-14，版本 cc6226f9）
