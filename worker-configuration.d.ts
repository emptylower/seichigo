/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 14a781fd79776b34794e6da1ba2033b8)
// Runtime types generated with workerd@1.20260410.1 2026-04-14 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		RATE_LIMIT_USER_PER_DAY: string;
		RATE_LIMIT_IP_PER_DAY: string;
		RATE_LIMIT_SALT: string;
		ADMIN_EMAILS: string;
		DATABASE_URL_UNPOOLED: string;
		ANITABI_CRON_SECRET: string;
		ANITABI_HOT_ANILIST_MAX_PAGES: string;
		ANITABI_HOT_CACHE_MINUTES: string;
		ANITABI_HOT_WINDOW_DAYS: string;
		CRON_SECRET: string;
		GEMINI_API_KEY: string;
		GOOGLE_DIRECTIONS_API_KEY: string;
		GOOGLE_SERVICE_ACCOUNT_JSON: string;
		MAPBOX_DIRECTIONS_TOKEN: string;
		NEON_PROJECT_ID: string;
		NEXT_PUBLIC_GOOGLE_MAPS_API_KEY: string;
		NEXT_PUBLIC_GOOGLE_MAPS_EMBED_API_KEY: string;
		NEXT_PUBLIC_GOOGLE_MAPS_STATIC_API_KEY: string;
		NEXT_PUBLIC_MAPTILER_KEY: string;
		NEXT_PUBLIC_MAP_PRELOAD_V2: string;
		NEXT_PUBLIC_MAP_STYLE_FAILOVER_TIMEOUT_MS: string;
		NEXT_PUBLIC_MAP_STYLE_PROVIDER_ORDER: string;
		NEXT_PUBLIC_MAP_VECTOR: string;
		NEXT_PUBLIC_STADIA_MAPS_API_KEY: string;
		OPS_CRON_SECRET: string;
		OPS_MAX_DEPLOYMENTS_PER_RUN: string;
		OPS_MAX_LOG_LINES_PER_RUN: string;
		OPS_MAX_STORED_EVENTS_PER_RUN: string;
		OPS_RETENTION_DAYS: string;
		OPS_VERCEL_API_TOKEN: string;
		OPS_VERCEL_PROJECT_ID: string;
		OPS_VERCEL_TEAM_ID: string;
		OPS_VERCEL_TIMEOUT_MS: string;
		OPS_WARN_4XX_THRESHOLD: string;
		PGDATABASE: string;
		PGHOST: string;
		...
		SEICHIGO_AI_API_KEY: string;
		SEO_AUTOMATION_AI_API_BASE_URL: string;
		SEO_AUTOMATION_AI_API_KEY: string;
		SEO_AUTOMATION_BASE_BRANCH: string;
		SEO_AUTOMATION_ENABLE_GENERATE: string;
		SEO_AUTOMATION_GITHUB_TOKEN: string;
		SEO_AUTOMATION_REPO: string;
		SEO_AUTOMATION_WORKFLOW_FILE: string;
		SERPAPI_KEY: string;
		VERCEL_OIDC_TOKEN: string;
		NEXT_PUBLIC_MAP_IMAGE_BREAKER_V2_ENABLED: string;
		NEXT_PUBLIC_MAP_IMAGE_LADDER_BGM_FALLBACK_ENABLED: string;
		MAP_IMAGE_SESSION_OUTCOME_V2_ENABLED: string;
		NEXT_PUBLIC_MAP_IMAGE_FORCE_DECORATE_FIRST_N: string;
		NEXT_PUBLIC_MAP_IMAGE_HOST_POLICY_PROXY_AWARE: string;
		HERE_API_KEY: string;
		PLAN_AGENT_API_KEY: string;
		PLAN_AGENT_BASE_URL: string;
		PLAN_AGENT_MODEL: string;
		CREEM_API_KEY: string;
		CREEM_API_BASE: string;
		CREEM_WEBHOOK_SECRET: string;
		CREEM_PRODUCT_STANDARD_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_MAP_IMAGE_R2_READ_ENABLED" | "NEXT_PUBLIC_MAP_IMAGE_R2_WRITE_ENABLED" | "PLAN_AGENT_QUEUE_ENABLED" | "BILLING_CHECKOUT_ENABLED" | "SITE_URL" | "NEXTAUTH_URL" | "NEXTAUTH_SECRET" | "DATABASE_URL" | "PGSSL" | "EMAIL_SERVER" | "EMAIL_FROM" | "NEXT_PUBLIC_GISCUS_REPO" | "NEXT_PUBLIC_GISCUS_REPO_ID" | "NEXT_PUBLIC_GISCUS_CATEGORY" | "NEXT_PUBLIC_GISCUS_CATEGORY_ID" | "RATE_LIMIT_USER_PER_DAY" | "RATE_LIMIT_IP_PER_DAY" | "RATE_LIMIT_SALT" | "ADMIN_EMAILS" | "DATABASE_URL_UNPOOLED" | "ANITABI_CRON_SECRET" | "ANITABI_HOT_ANILIST_MAX_PAGES" | "ANITABI_HOT_CACHE_MINUTES" | "ANITABI_HOT_WINDOW_DAYS" | "CRON_SECRET" | "GEMINI_API_KEY" | "GOOGLE_DIRECTIONS_API_KEY" | "GOOGLE_SERVICE_ACCOUNT_JSON" | "MAPBOX_DIRECTIONS_TOKEN" | "NEON_PROJECT_ID" | "NEXT_PUBLIC_GOOGLE_MAPS_API_KEY" | "NEXT_PUBLIC_GOOGLE_MAPS_EMBED_API_KEY" | "NEXT_PUBLIC_GOOGLE_MAPS_STATIC_API_KEY" | "NEXT_PUBLIC_MAPTILER_KEY" | "NEXT_PUBLIC_MAP_PRELOAD_V2" | "NEXT_PUBLIC_MAP_STYLE_FAILOVER_TIMEOUT_MS" | "NEXT_PUBLIC_MAP_STYLE_PROVIDER_ORDER" | "NEXT_PUBLIC_MAP_VECTOR" | "NEXT_PUBLIC_STADIA_MAPS_API_KEY" | "OPS_CRON_SECRET" | "OPS_MAX_DEPLOYMENTS_PER_RUN" | "OPS_MAX_LOG_LINES_PER_RUN" | "OPS_MAX_STORED_EVENTS_PER_RUN" | "OPS_RETENTION_DAYS" | "OPS_VERCEL_API_TOKEN" | "OPS_VERCEL_PROJECT_ID" | "OPS_VERCEL_TEAM_ID" | "OPS_VERCEL_TIMEOUT_MS" | "OPS_WARN_4XX_THRESHOLD" | "PGDATABASE" | "PGHOST" | "PGHOST_UNPOOLED" | "PGPASSWORD" | "PGUSER" | "POSTGRES_DATABASE" | "POSTGRES_HOST" | "POSTGRES_PASSWORD" | "POSTGRES_PRISMA_URL" | "POSTGRES_URL" | "POSTGRES_URL_NON_POOLING" | "POSTGRES_URL_NO_SSL" | "POSTGRES_USER" | "RESEND_API_KEY" | "SEICHIGO_AI_API_KEY" | "SEO_AUTOMATION_AI_API_BASE_URL" | "SEO_AUTOMATION_AI_API_KEY" | "SEO_AUTOMATION_BASE_BRANCH" | "SEO_AUTOMATION_ENABLE_GENERATE" | "SEO_AUTOMATION_GITHUB_TOKEN" | "SEO_AUTOMATION_REPO" | "SEO_AUTOMATION_WORKFLOW_FILE" | "SERPAPI_KEY" | "VERCEL_OIDC_TOKEN" | "NEXT_PUBLIC_MAP_IMAGE_BREAKER_V2_ENABLED" | "NEXT_PUBLIC_MAP_IMAGE_LADDER_BGM_FALLBACK_ENABLED" | "MAP_IMAGE_SESSION_OUTCOME_V2_ENABLED" | "NEXT_PUBLIC_MAP_IMAGE_FORCE_DECORATE_FIRST_N" | "NEXT_PUBLIC_MAP_IMAGE_HOST_POLICY_PROXY_AWARE" | "HERE_API_KEY" | "PLAN_AGENT_API_KEY" | "PLAN_AGENT_BASE_URL" | "PLAN_AGENT_MODEL" | "CREEM_API_KEY" | "CREEM_API_BASE" | "CREEM_WEBHOOK_SECRET" | "CREEM_PRODUCT_STANDARD_ID">> {}
}
