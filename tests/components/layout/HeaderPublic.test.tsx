...
describe('HeaderPublic', () => {
  ...
  it('keeps primary navigation links in desktop navigation area', () => {
    ...
    expect(nav?.textContent).toContain('AI Planner')
    expect(nav?.textContent).toContain('Pilgrimage Map')
    expect(nav?.textContent).toContain('Pilgrimage Guides')
    expect(nav?.textContent).toContain('Pilgrimage Cities')
