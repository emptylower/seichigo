...
export const FIRST_VIEW_DESKTOP_CANARY_SLOTS: FirstViewCanarySlot[] = [
  ...
  { slotKey: 'thumb-100001:p001', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/a.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100001:p002', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/b.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100002:p003', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/c.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100002:p004', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/d.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100003:p005', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/e.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100003:p006', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/f.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100004:p007', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/g.jpg', expectedTier: 'render proxy only for point thumbnails' },
  { slotKey: 'thumb-100004:p008', slotType: 'point-thumbnail', sourceUrl: 'https://www.anitabi.cn/images/user/0/h.jpg', expectedTier: 'render proxy only for point thumbnails' },
