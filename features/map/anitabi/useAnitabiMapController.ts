...
import { useMapInteractionActions } from './useMapInteractionActions'
import AnitabiMapLayout from './AnitabiMapLayout'
import { useAnitabiBootstrapData } from './useAnitabiBootstrapData'
import { useAnitabiDerivedState } from './useAnitabiDerivedState'
import { useAnitabiSelection } from './useAnitabiSelection'
import { useAnitabiWarmup } from './useAnitabiWarmup'
import { useCompleteMode } from './useCompleteMode'
import { useMapCamera } from './useMapCamera'
import { useMapStyleFailover } from './useMapStyleFailover'
...
import type { WindowExcerptBangumiItem, WindowExcerptPointItem } from './windowExcerpt'

export function useAnitabiMapController(
  { locale, initialBootstrap }: Props
): ComponentProps<typeof AnitabiMapLayout> {
