...
import { createHandlers } from '@/lib/anitabi/handlers/adminImageMirrorCleanup'
...
export async function POST() {
  try {
    ...
    return await createHandlers(deps).POST()
  } catch (err) {
    console.error('[api/admin/anitabi/image-mirror/cleanup] POST failed', err)
