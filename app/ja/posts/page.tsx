...
export function generateMetadata(): Metadata {
  return {
    ...
    openGraph: { type: 'website', url: '/ja/posts', title: TITLE, description: DESCRIPTION, images: [pageCardImage('site', 'home', 'ja', 'SeichiGo アニメ聖地巡礼')] },
    twitter: { card: 'summary_large_image', title: TITLE, description: DESCRIPTION, images: [pageCardImage('site', 'home', 'ja', 'SeichiGo アニメ聖地巡礼')] },
  }
}
